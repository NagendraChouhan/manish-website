...
function App() {
  ...
  // const serverHost = 'https://loan-application2.herokuapp.com';
  // const alert = document.querySelector('.alert');

  // const onSubmit = async (e) => {
  //   e.preventDefault();
  //   const response = await fetch(
  //     // `https://loan-application2.herokuapp.com/send`,
  //     `${serverHost}/send`,
  //     {
  //       method: 'POST',
  //       headers: {
    ...
    <>
      ...
      <div className='container pt-5 mt-5'>
        <article className="about shadow pb-5">
          ...
          <form className="about-content text-center" method='post' action='https://loan-application-app.herokuapp.com/'>
